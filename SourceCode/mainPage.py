...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.logView = QtWidgets.QScrollArea(self.layoutWidget)
        self.logView.setWidgetResizable(True)
        self.logView.setObjectName("logView")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 280, 184))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.logView.setWidget(self.scrollAreaWidgetContents)
