...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.isReg = QtWidgets.QLabel(self.layoutWidget)
        self.isReg.setObjectName("isReg")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.isReg)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_5.setText(_translate("Dialog", "是否通告"))
